<template>
  <div class="flex flex-row justify-content-between row-gap-3 mr-5 mt-1 mb-1">
    <div class="header-contact">
          <a href="tel:+71234567890">
            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon-1" viewBox="0 0 1408 1408">
      ...
      <div class="header-contact">
          <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon-1" viewBox="0 0 1536 1536">
