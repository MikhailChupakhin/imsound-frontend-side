      ...
      <div class="card-content">
        ...
        <div v-if="viewMode === 'list'">
          ...
          <div v-else class="cart-btn-wrapper">
            <CommonInterfaceButton buttonText="предзаказ" @click="handleBuyoneclick(productInfo)" :customStyle="{ 'background-color': 'rgb(193, 111, 111)' }"/>
          </div>
...
@media screen and (min-width: 768px) {
  ...
  .list-mode .product-card .card-border {
    width: 50%;
    height: 100%;
  }
