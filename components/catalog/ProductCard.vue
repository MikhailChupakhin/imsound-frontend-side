...
<template>
  <div :class="{ 'product-card text-center': true, 'comparison': isInComparisonList }" @mouseenter="showCartButton" @mouseleave="hideCartButton">
    ...
    <div class="flex flex-row card-menu">
      ...
      <div class="card-icon ml-2" @click="handleComparison(productInfo, $event)" title="Сравнение">
      ...
      <div class="card-icon ml-2" @click="handleBuyoneclick(productInfo)" title="Купить в 1 клик">
    ...
    <div v-else class="cart-btn-wrapper">
      <button class="add-to-cart-btn preorder-btn" ref="cartButton" @click="handleBuyoneclick(productInfo)">предзаказ</button>
    </div>
  </div>
</template>
