    ...
    <div>
        <div class="sorting-wrapper">
            <div class="view-mode-buttons">
                <div @click="setGridViewMode" :class="{ active: viewMode === 'grid' }" role="button" tabindex="0" aria-label="Включить режим отображения: сетка" title="Режим отображение - сетка">
                ...
                <div @click="setListViewMode":class="{ active: viewMode === 'list' }" role="button" tabindex="0" aria-label="Включить режим отображения: список" title="Режим отображение - список">
                    <i class="fa"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
