  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://imsound.ru/media/blog/images/hotline_p3p0b1W.webp' },
        { name: 'twitter:title', content: 'Заголовок страницы' },
        { name: 'twitter:description', content: 'Описание страницы' },
        { name: 'twitter:image', content: 'https://imsound.ru/media/blog/images/hotline_p3p0b1W.webp' },
      ],
    },
  },
